...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-dark-900">
      {/* 헤더 */}
      <header className="border-b border-dark-800 bg-dark-900/80 backdrop-blur-xl sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Link href="/chat" className="p-2 hover:bg-dark-800 rounded-lg transition-colors">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="font-semibold text-white">관리자 대시보드</h1>
                <p className="text-xs text-dark-400">시스템 현황 모니터링</p>
              </div>
            </div>
          </div>
    ...
    <div className="min-h-screen bg-dark-900 flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <div className="flex gap-3 justify-center">
          <Link href="/chat">
            <Button variant="secondary">채팅으로 돌아가기</Button>
          </Link>
